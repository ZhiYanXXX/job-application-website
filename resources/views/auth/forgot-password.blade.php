...
<body>
    ...
    <div class="auth-container">
        ...
        @if(session('status'))
            <div style="background: var(--success-bg); color: var(--success-color); padding: 1rem; border-radius: 5px; margin-bottom: 1.5rem; border: 1px solid var(--success-color); font-size: 0.9rem; text-align: center;">
                {{ session('status') }}
            </div>
        @endif
