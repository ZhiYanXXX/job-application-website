...
<body>
    ...
    <div class="auth-container">
        ...
        <div class="prototype-notice">
            <strong>Prototype Demo:</strong><br> Use <em>admin@easyjob.com</em> and <em>password123</em> to log in.
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" value="{{ old('email', 'admin@easyjob.com') }}" required autofocus class="form-input">
            ...
            <div class="form-group" style="display: flex; justify-content: flex-end;">
                <a href="{{ route('password.request') }}" style="font-size: 0.9rem; color: var(--primary-color); text-decoration: none; font-weight: 500;">Forgot your password?</a>
            </div>
